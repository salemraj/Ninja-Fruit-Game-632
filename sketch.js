var knife,toucher,gameOver,smileyBallsGroup1,smileyBallsGroup2,smileyBallsGroup3,
smileyBallsGroup4,guavasGroup1,guavasGroup2,guavasGroup3,guavasGroup4,
applesGroup1,applesGroup2,applesGroup3,applesGroup4,bananasGroup1,
bananasGroup2,bananasGroup3,bananasGroup4,orangesGroup1,orangesGroup2,
orangesGroup3,orangesGroup4,gameOver,restart_button,play,play_button;
...
function preload()
{
  ...
  gameOverImage = loadImage("Game Over text.png");
  ...
  playImg = loadImage("Play text.png");
  play_buttonImg = loadImage("Play button.png")
}
...
function setup() 
{
  ...
  toucher = createSprite(-300,100,20,20);
  ...
  play_button = createSprite(width/2,140);
  play_button.scale = 0.25;
  play_button.addImage(play_buttonImg);
  play_button.visible = true;
  play_button.setCollider("circle",0,-2,140)
  play_button.debug = false;
  
  
  //code to make the game over invisible
  gameOver.visible = false;
  
  restart_button = createSprite(width/2,height/2  + 70);
  restart_button.scale = 0.25;
  restart_button.addImage(restartImg);
  restart_button.visible = false;
  restart_button.setCollider("circle",0,-2,160)
  restart_button.debug = false;
  ...
  if(gameState == START)
    {
      ...
      knife.y = height/2
       ...
       toucher.x=World.mouseX;
      
      //code to make to move the knife with the Y position of the mouse
      toucher.y=World.mouseY;
      
      choppedScore = 0;
      speedScore = 0;
      
      if(toucher.isTouching(play_button) || mousePressedOver(play_button))
        {
          gameState = PLAY;
}
    }
  ...
  if(gameState == END)
    {
      ...
      if(mousePressedOver(restart_button) || toucher.isTouching(restart_button))
        {
         reset();
         }
